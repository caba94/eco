 ...
 */
final class Version20200708075855 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE craft ADD raw2_id INT DEFAULT NULL, ADD raw3_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE craft DROP raw2_id, DROP raw3_id');
    }
}
